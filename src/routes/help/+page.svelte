			...
			<div class="body">
				...
				<ul>
					...
					<li>
						...
						as incomplete. Requests are paced to protect the shared eBird allowance;
						if eBird asks the app to slow down, the comparison shows the wait and
						resumes automatically when it is safe. In the planner, press
						<strong>Use compared ranking</strong> explicitly before it changes the
						suggested route.
					</li>
					<li>
